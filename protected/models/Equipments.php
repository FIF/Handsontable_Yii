...
class Equipments extends CActiveRecord
{
	...
	protected static function listEquipmentName() {
		// TODO list equipment should be in other table
		// here we only get all unique from DB.

		$list = Yii::app()->db->createCommand('select distinct(name)  from equipments')->query();
		return $list;
	}
}